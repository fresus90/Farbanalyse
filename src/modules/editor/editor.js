...
export function initTouchup(){
  ...
  imgC.src=cutoutDataUrl;imgO.src=originalDataUrl;
...
export function applyTouchup(){
  ...
  finalDataUrl=tu.canvas.toDataURL('image/png');cutoutDataUrl=finalDataUrl;
  ...
  document.getElementById('editMode').style.display='none';document.getElementById('viewMode').style.display='block';showInView(finalDataUrl);
}
